  ...
  const footerCols = [
    {
      ...
      links: products.map((p) => ({
        key: p.slug,
        name: t(`solutions.products.${p.slug}.short`),
    ...
    },
    {
      key: "company",
      links: [
        { key: "about", name: t("footer.company.about"), href: "/about" },
        { key: "industries", name: t("footer.company.industries"), href: "/industries" },
        { key: "pricing", name: t("footer.company.pricing"), href: "/pricing" },
        { key: "contact", name: t("footer.company.contact"), href: "/contact" },
      ],
    },
    {
      key: "resources",
      links: [
        { key: "requestDemo", name: t("footer.resources.requestDemo"), href: "/contact" },
        { key: "documentation", name: t("footer.resources.documentation"), href: "/solutions" },
        { key: "support", name: t("footer.resources.support"), href: "/contact" },
        { key: "privacy", name: t("footer.resources.privacy"), href: "/privacy" },
        { key: "terms", name: t("footer.resources.terms"), href: "/terms" },
      ],
    },
  ];
    ...
    <footer className="relative border-t border-border bg-secondary/40">
      <div className="max-w-[1320px] mx-auto px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          {footerCols.map((col) => (
            <div key={col.key}>
              <h4 className="font-medium text-foreground mb-4">{t(`footer.columns.${col.key}`)}</h4>
